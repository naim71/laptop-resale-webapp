...
const CategoryCard = ({category}) => {
    ...
    return (
        <Link to={`/category/${categoryId}`} className="w-96 h-96 bg-[#FFFCFB] rounded-3xl shadow-xl text-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 mb-10">
